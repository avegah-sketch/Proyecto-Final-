    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4">
      <Card className="w-full max-w-md p-8">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ¿No tienes cuenta? <Link href="/auth/registro" className="text-indigo-600 hover:text-indigo-700 font-medium">Regístrate</Link>
        </p>
        <div className="mt-4 pt-4 border-t border-gray-200">
          <p className="text-xs text-gray-400 text-center">Prueba: comprador@marketplace.com / demo123</p>
        </div>
      </Card>
    </div>
  );
